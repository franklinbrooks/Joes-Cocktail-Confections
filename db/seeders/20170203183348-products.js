...
module.exports = {
  up: function (queryInterface, Sequelize) {
    return queryInterface.bulkInsert('Products', [
      ...
      { product_name: '99 Banana Split', category: 'Cupcakes', alcohol: true, image: '/images/cupcakes/buttercream.jpg', unitSize: '8', description: 'Yummy vanilla cupcake infused with 99 proof banana liqueur. Get the banana with no peel!', dietaryRestrictions: 'nut-free, vegetarian', price: 350, createdAt: '2017-01-31', updatedAt: '2017-01-31' },
      { product_name: 'Sangria Brunch', category: 'Cupcakes', alcohol: true, image: '/images/cupcakes/buttercream.jpg', unitSize: '8', description: 'Fresh strawberries mixed with exotic sangria create this brunch inspired dessert.', dietaryRestrictions: 'nut-free, vegetarian', price: 350, createdAt: '2017-01-31', updatedAt: '2017-01-31' },
